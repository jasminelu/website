...
<table width="1009" height="1044" border="0" align="center" cellspacing="0">
 ...
 %>
    ...
    <p>&nbsp;</p>
      <p>&nbsp;</p></td>
    <td width="810" colspan="2"><p><span class="font_14"><img src="images/icon.gif" width="11" height="11" /><span class="font_02 font_14"><strong>应急通信系统解决方案</strong></span></span></p>
      <p><strong>海事卫星应急通信解决方案</strong> <span class="STYLE1">(如图)</span></p>
      <p><img src="images/业务7.1.gif" width="534" height="329" /></p>
      <p><strong>3G应急通信解决方案 </strong><span class="STYLE1">（如图）</span></p>
      <p><img src="images/业务7.2.gif" width="504" height="252" /></p>
      <p><strong>单兵无线图传解决方案</strong> <span class="STYLE1">（如图）</span></p>
      <p><img src="images/业务7.3.gif" width="536" height="186" /></p>
      <p><strong>高铁应急通信解决方案</strong> <span class="STYLE1">（如图）</span></p>
      <p><img src="images/业务7.4.gif" width="500" height="261" /></p>
